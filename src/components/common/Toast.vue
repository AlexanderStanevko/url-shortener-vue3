...
const typeIcon = computed(() => {
  switch (props.toast.type) {
    ...
    case 'info':
    default:
      return `<svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2h-1V9a1 1 0 00-1-1z" clip-rule="evenodd" /></svg>`;
  }
});
</script>

<template>
  <div class="toast animate-slide-up max-w-md w-full rounded-lg shadow-lg overflow-hidden mb-3" :class="typeClasses">
    <div class="p-3 flex items-start">
      <div class="flex-shrink-0" v-html="typeIcon"></div>
      <div class="ml-3 flex-1">
        <p class="text-sm font-medium">{{ toast.message }}</p>
      </div>
      <div class="ml-3 flex-shrink-0">
        <button @click="close" class="inline-flex text-white focus:outline-none">
